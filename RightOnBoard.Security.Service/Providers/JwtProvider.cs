...
namespace RightOnBoard.Security.Service.Providers
{
    public class JwtProvider
    {
        ...
        public ClaimsIdentity CreateIdentity(bool isAuthenticated, string userId, string userName, dynamic payload)
        {
        ...
        public async Task<string> FindRefreshTokenAsync(string refreshToken)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(_tokenUri);
        ...
        public async Task<string> Logout(string refreshToken, string uri)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(_tokenUri);
